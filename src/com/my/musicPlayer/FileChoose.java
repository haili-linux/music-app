...
public class FileChoose
{
	...
	private static FileChoose util = null;
	public static int TEPY = 232324773;
	private FileChoose(Context context) {
		this.context = context;
	}

	public static FileChoose getInstance(Context context) {
		if (util == null) {
			util = new FileChoose(context);
		}
		return util;
	}
